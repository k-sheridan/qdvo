 ...
 */
TEST_F(QDVOBasicTest, EstimateDepth) {
  ...
  std::cout << std::endl
            << targetPixel << landmark.px << std::endl;
  ...
  landmark.depthEstimator.update(graph, sourceKeyframe, targetKeyframe, landmark, *patchComparer, *patchWarper);
