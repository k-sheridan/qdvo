...
.. _program_listing_file_src_DataStructures_Patch.cpp:

Program Listing for File Patch.cpp
==================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_DataStructures_Patch.cpp>` (``src/DataStructures/Patch.cpp``)
