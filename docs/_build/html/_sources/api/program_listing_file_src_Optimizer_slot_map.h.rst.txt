...
.. _program_listing_file_src_Optimizer_slot_map.h:

Program Listing for File slot_map.h
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_Optimizer_slot_map.h>` (``src/Optimizer/slot_map.h``)
...
.. code-block:: cpp
   ...
   // Taken from the SG14 github repository. Credit: Allan Deutsch
