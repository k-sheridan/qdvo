...
class FrontEndVisualOdometry {
 public:
  ...
  ArgMin::ErrorTermContainer<QuasiDirectErrorTerm_TargetFrame>
      errorTermContainer;
  ...
  using Solver = ArgMin::PSDSchurSolver<
      ...
      ArgMin::ErrorTermGroup<QuasiDirectErrorTerm_TargetFrame>,
      ArgMin::VariableGroup<ArgMin::SE3>, ArgMin::VariableGroup<>>;
  ...
  /**
   * Sets up all error terms for the current frame, and solves for the current
   * frame pose.
