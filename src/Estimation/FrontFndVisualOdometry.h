...
public:
    ...
    ArgMin::ErrorTermContainer<QuasiDirectErrorTerm> errorTermContainer;

    using LossFunction = ArgMin::HuberLossFunction<double>;

    LossFunction lossFunction = LossFunction(1000);

    using Solver = ArgMin::PSDSchurSolver<ArgMin::Scalar<double>, ArgMin::LossFunction<LossFunction>, ArgMin::ErrorTermGroup<QuasiDirectErrorTerm>, ArgMin::VariableGroup<ArgMin::SE3>, ArgMin::VariableGroup<>>;
