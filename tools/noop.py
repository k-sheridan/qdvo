...
if __name__ == "__main__":
    ...
    evaluate(args.visualizerBinaryPath, args.datasetPath, args.visualize, args.frames, basePath)
    ...
    build_dataset_player()
    evaluate(args.visualizerBinaryPath, args.datasetPath, args.visualize, args.frames, comparePath)

    subprocess.call(['git', 'checkout', currentHash])

    subprocess.call(['diff', os.path.join(basePath, 'metrics.json'), os.path.join(comparePath, 'metrics.json')])
