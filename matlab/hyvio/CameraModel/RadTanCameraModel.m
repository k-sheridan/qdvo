classdef RadTanCameraModel
    ...
    methods
        function obj = RadTanCameraModel(distortionCoeffs, fov, focal, principal, size, n, attenuation)
            ...
            obj.radiusLookupTable(:, 1) = linspace(0, norm(size), n);
            ...
            for tableIndex = (1:n)
                multiplier = 1 + obj.coeffs(1)*obj.radiusLookupTable(tableIndex, 1)^2 +  obj.coeffs(2)*obj.radiusLookupTable(tableIndex, 1)^4;
        ...
        function [pixel, projectJacobian] = project(obj, pointInCameraFrame)
            ...
            pxRect = [obj.f(1)*pointInCameraFrame(1) + obj.c(1); obj.f(2)*pointInCameraFrame(2) + obj.c(2)];
