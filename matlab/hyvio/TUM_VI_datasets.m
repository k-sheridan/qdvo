...
clear all
%% DATASET
datasetPath = 'datasets/dataset-room2_512_16/mav0/';

vignette = imread('datasets/dataset-room2_512_16/dso/cam0/vignette.png', 'PNG'); % used as mask for feature tracking and selection
